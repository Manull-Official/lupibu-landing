...
const translations = {
    en: {
        ...
        'referral.subtitle': 'Download Lupibu — your invite unlocks Pro perks below.',
        'referral.benefit_trial': '7-day Pro trial — free',
        'referral.benefit_yearly': 'Special discount on the yearly plan',
        'referral.promocodeLabel': 'Your invite code',
        'referral.copyCode': 'Copy code',
        'referral.step1Title': 'Install Lupibu',
        'referral.step1Or': 'or find Lupibu by searching in the App Store:',
        'referral.step2Title': 'Apply your code',
        'referral.step2Text': 'On the Welcome screen tap «I have a code» and enter the code above.',
    ...
    ru: {
        ...
        'referral.subtitle': 'Скачайте Lupibu — приглашение откроет Pro-плюшки ниже.',
        'referral.benefit_trial': '7 дней Pro — бесплатно',
        'referral.benefit_yearly': 'Особая скидка на годовую подписку',
        'referral.promocodeLabel': 'Ваш промокод',
        'referral.copyCode': 'Скопировать код',
        'referral.step1Title': 'Установите Lupibu',
        'referral.step1Or': 'или найдите Lupibu через поиск App Store:',
        'referral.step2Title': 'Примените промокод',
        'referral.step2Text': 'На экране входа тапните «У меня есть код» и введите код выше.',
    ...
    kk: {
        ...
        'referral.subtitle': 'Lupibu-ны жүктеп алыңыз — шақыру төмендегі Pro-артықшылықтарды ашады.',
        'referral.benefit_trial': '7 күн Pro — тегін',
        'referral.benefit_yearly': 'Жылдық жазылымға арнайы жеңілдік',
        'referral.promocodeLabel': 'Сіздің промокодыңыз',
        'referral.copyCode': 'Кодты көшіру',
        'referral.step1Title': 'Lupibu-ны орнатыңыз',
        'referral.step1Or': 'немесе App Store іздеуінен Lupibu-ны табыңыз:',
        'referral.step2Title': 'Кодты қолданыңыз',
        'referral.step2Text': 'Кіру бетінде «Менде код бар» дегенді басып, жоғарыдағы кодты енгізіңіз.',
        'referral.codeLabel': 'Промокод:',
