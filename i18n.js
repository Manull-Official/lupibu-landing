...
const translations = {
    en: {
        ...
        'referral.step1Title': 'Get Lupibu',
        'referral.step1Or': 'or',
        'referral.step2Title': 'Enter the code',
        'referral.step2Hint': 'On the Welcome screen, tap «I have a code».',
    ...
    ru: {
        ...
        'referral.step1Title': 'Скачайте Lupibu',
        'referral.step1Or': 'или',
        'referral.step2Title': 'Введите код',
        'referral.step2Hint': 'На экране Welcome тапните «У меня есть код».',
    ...
    kk: {
        ...
        'referral.step1Title': 'Lupibu-ны жүктеңіз',
        'referral.step1Or': 'немесе',
        'referral.step2Title': 'Кодты енгізіңіз',
        'referral.step2Hint': 'Welcome бетінде «Менде код бар» дегенді басыңыз.',
        'referral.disclaimer': '*Тек жаңа қолданушылар үшін.',
