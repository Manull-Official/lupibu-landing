...
const translations = {
    en: {
        ...
        'referral.howto': 'Find Lupibu in the App Store, then enter the code on the Welcome screen.',
        'referral.disclaimer': 'Already have Lupibu? Discount applies to new sign-ups only.',
    ...
    ru: {
        ...
        'referral.howto': 'Найдите Lupibu в App Store, затем введите код на экране входа.',
        'referral.disclaimer': 'Уже есть Lupibu? Скидка действует только для новых регистраций.',
    ...
    kk: {
        ...
        'referral.howto': 'App Store-дан Lupibu-ны тауып, кіру бетінде кодты енгізіңіз.',
        'referral.disclaimer': 'Lupibu қазірден бар ма? Жеңілдік тек жаңа тіркелулерге қолданылады.',
