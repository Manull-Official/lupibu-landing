...
const translations = {
    en: {
        ...
        'referral.step1AltHint': 'The code applies automatically.',
        'referral.step2Title': 'Sign in with Apple',
        'referral.step2Hint': 'If the code didn’t apply, enter it on the Welcome screen.',
    ...
    ru: {
        ...
        'referral.step1AltHint': 'Промокод применится автоматически.',
        'referral.step2Title': 'Войдите через Apple',
        'referral.step2Hint': 'Если промокод не применился — введите его на экране Welcome.',
    ...
    kk: {
        ...
        'referral.step1AltHint': 'Промокод автоматты түрде қолданылады.',
        'referral.step2Title': 'Apple арқылы кіріңіз',
        'referral.step2Hint': 'Егер промокод қолданылмаса — оны Welcome бетінде енгізіңіз.',
