...
*   **Данные аккаунта:** Ваше имя, полученное через Apple Sign-In при регистрации. Мы не собираем ваш адрес электронной почты — Apple Sign-In обеспечивает аутентификацию без передачи email нам.
...
*   Мы не собираем ваш адрес электронной почты, номер телефона или данные о местоположении.
...
|---|---|---|---|
| Google Cloud Platform | Хостинг, база данных, хранение фотографий | Все данные приложения, загруженные фотографии | США |
| Firebase Auth | Аутентификация пользователей | Токен Apple Sign-In, ID пользователя | США |
...
| Sentry | Отчёты об ошибках | Логи ошибок, состояние устройства, стек вызовов | США |
...
6.1. Ваши данные могут передаваться и обрабатываться в странах за пределами Республики Казахстан, включая Соединённые Штаты Америки и государства — члены ЕС (Германия).
...
*   **Аккаунт деректері:** Тіркелу кезінде Apple Sign-In арқылы алынған сіздің есіміңіз. Біз сіздің электрондық пошта мекенжайыңызды жинамаймыз — Apple Sign-In аутентификацияны email-ді бізге бермей қамтамасыз етеді.
...
*   Біз сіздің электрондық пошта мекенжайыңызды, телефон нөміріңізді немесе орналасу деректеріңізді жинамаймыз.
...
|---|---|---|---|
| Google Cloud Platform | Хостинг, деректер қоры, фотосуреттерді сақтау | Қосымшаның барлық деректері, жүктелген фотосуреттер | АҚШ |
| Firebase Auth | Пайдаланушы аутентификациясы | Apple Sign-In токені, пайдаланушы ID | АҚШ |
...
| Sentry | Қателер туралы есептер | Қате журналдары, құрылғы күйі, шақырулар стегі | АҚШ |
...
6.1. Сіздің деректеріңіз Қазақстан Республикасынан тыс елдерге, соның ішінде Америка Құрама Штаттары мен ЕО мүше мемлекеттеріне (Германия) берілуі және өңделуі мүмкін.
...
|---|---|---|
| Google Cloud Platform | Хостинг базы данных, серверная инфраструктура, хранение фотографий | США |
| Firebase (Google) | Аутентификация пользователей, аналитика | США |
| PostHog | Продуктовая аналитика | Европейский Союз (Франкфурт) |
| Sentry | Мониторинг сбоев и ошибок | США |
...
|---|---|---|
| Google Cloud Platform | Деректер базасын хостинг, серверлік инфрақұрылым, фотосуреттерді сақтау | АҚШ |
| Firebase (Google) | Пайдаланушыларды аутентификациялау, аналитика | АҚШ |
| PostHog | Өнімдік аналитика | Еуропалық Одақ (Франкфурт) |
| Sentry | Қателіктер мен ақаулар мониторингі | АҚШ |
